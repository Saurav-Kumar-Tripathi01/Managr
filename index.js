...
if (process.env.YOUTUBE_COOKIE && process.env.YOUTUBE_COOKIE.length > 0) { // Check if cookie exists
    play.setToken({
        youtube: {
    ...
    console.warn('⚠️ No YouTube cookie found in .env. Music playback may be unstable or fail.');
}
